...
class Trader:
    ...
    def bid(self):
        # We didnt change the algorithm for Round 2 at all. Since we mainly have a Maker Strategy, a bigger order book
        # is marginally better. By simulating on our own 20% increased order books, we expected around 1k improvement
        # So a bid of 500 was reasonable
        return 500
